...
import io.github.youndie.shildik.server.boot.optional
import io.github.youndie.shildik.server.boot.runShildik
import io.github.youndie.shildik.storage.sqlx4k.sqlite.sqlx4kSqliteStorageModule

/**
 * The reference distribution, storing everything in one file.
 *
 * The same provider as [io.github.youndie.shildik.distribution] — the same sign-in methods, the
