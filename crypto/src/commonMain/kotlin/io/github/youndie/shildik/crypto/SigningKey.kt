...
public class SigningKey(
    ...
    public suspend fun sign(data: ByteArray): ByteArray = privateKey.signatureGenerator().generateSignature(data)
    ...
    public suspend fun publicJwk(): JsonObject {
    ...
    public suspend fun encodePrivate(): ByteArray = privateKey.encodeToByteArray(RSA.PrivateKey.Format.DER)
    ...
    public companion object {
         ...
         */
        public suspend fun generate(kid: String): SigningKey {
        ...
        public suspend fun fromPrivateDer(
            kid: String,
            der: ByteArray,
        ): SigningKey {
            val algorithm = CryptographyProvider.Default.get(RSA.PKCS1)
